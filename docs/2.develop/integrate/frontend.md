...
```
<details><summary>일반 HTML에서의 사용</summary>
...
지갑을 인스턴스화할 때, **[함수 호출 키](../../1.concepts/basics/accounts/access-keys.md#function-call-keys-function-call-keys)**를 생성할지 여부를 선택할 수 있습니다.
